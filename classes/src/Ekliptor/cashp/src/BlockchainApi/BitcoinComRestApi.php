...
class BitcoinComRestApi extends AbstractBlockchainApi {
	...
	public function createNewAddress(string $xPub, int $addressCount, string $hdPathFormat = '0/%d') {
	...
	public function getSlpAddressDetails(string $address, string $tokenID) {
	...
	protected function getTransactionDetails(string $transactionID) {
