...
abstract class AbstractBlockchainApi {
	 ...
	 */
	public abstract function createNewAddress(string $xPub, int $addressCount, string $hdPathFormat = '0/%d');
	 ...
	 */
	public abstract function getTokenInfo(string $tokenID);
	 ...
	 */
	public abstract function getAddressDetails(string $address);
	 ...
	 */
	public abstract function getSlpAddressDetails(string $address, string $tokenID);
	 ...
	 * @return BchAddress the address or null on failure
	 */
	public function createNewEmptyAddress(string $xPub, int $addressCount, string $hdPathFormat = '0/%d', string $tokenID = "") {
		while (true)
		{
